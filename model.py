...
DATA_FILE = 'data_file_name.csv'  # data file name
TOTAL_TIME = 48 * 60  # total game time = 48 min * 60 s/min
...
def get_time_remaining(quarter, times):
    """converts elapsed time to remaining time as integer (seconds)
    """
...
def get_classifier(df):
    """trains and returns logistic regression classifier
    """
...
def plot_graph(time_remaining_list, event_probs):
...
def main():
    ...
    # plot win probability graph
    plot_graph(time_remaining_list, event_probs)
